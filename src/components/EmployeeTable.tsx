            ...
            return (
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] font-bold text-slate-400 mt-0.5">
                        ID: {employee.employeeCode} • {employee.location}
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-x-6 gap-y-3">
                  ...
                  <MobileStat
                    label="Collection"
                    value={formatCurrency(employee.totalCollection)}
                    tone="emerald"
                  />
                  <MobileStat
                    label="Total Due"
                    value={formatCurrency(employee.totalDue)}
                    tone="rose"
                  />
                  <MobileStat
                    label="Re-Enrollment Count"
                    value={formatNumber(employee.reEnrolmentCount)}
                    tone="emerald"
                  />
                  <MobileStat
                    label="Re-Enrollment Value"
                    value={formatCurrency(employee.reEnrolmentValue)}
                    tone="emerald"
                  />
                </div>
              </button>
              ...
              filteredData.map((employee) => {
                ...
                return (
                  ...
                  >
                    ...
                    <RowValue
                      value={formatNumber(employee.collectionCustomerCount)}
                      align="right"
                    />
                    <RowValue
                      value={formatNumber(employee.dueCustomerCount)}
                      tone="rose"
                      align="right"
                    />
                    <RowValue
